...
Finally, we discuss the usage of Pretrained Language Models as dialogue models and try to answer whether these models can close the gap between unsupervised and supervised systems.
...
in this chapter, we address the challenges of action selection and interface interaction.
To enable the model to interact with external sources of information via API, we decided to annotate points in the training dialogues in which the interaction with an external API is needed.
...
\begin{table*}[tp]
    ...
    \end{tabular}
    \vspace{-2mm}
    \caption{An example dialogue drawn from the CamRest676 validation set illustrates our injection of database interaction turns. We show the user input (or inserted database results), the gold-standard system response, and system action annotation based on manual rules. In the first turn, a database query is constructed, and the second turn illustrates how the result is retrieved and fed as input. Values inferred correctly by our system are depicted in green.
...
\begin{tabular}{l|c|c|c}
      \toprule
      \textbf{Source} & CamRest676 action & MultiWOZ action & MultiWOZ domain \\
      \midrule
...
A structured representation of utterances in the dialogue (Chapter~\ref{02:sec:basics}) is hierarchical because it's a composition of several concepts that can constrain each other.
...
VAEs for hierarchical architecture was successfully applied in the computer vision domain \cite{vahdat2020nvae,li2020progressive}.
...
\begin{figure}[h]
\centering
\subfloat[level 1]{\label{sfig:a0}\includegraphics[width=.33\textwidth]{images/lava-tsne/ae-lvl-0-nll.png}}\hfill
\subfloat[level 2]{\label{sfig:a1}\includegraphics[width=.33\textwidth]{images/lava-tsne/ae-lvl-1-nll.png}}\hfill
\subfloat[level 3]{\label{sfig:a2}\includegraphics[width=.33\textwidth]{images/lava-tsne/ae-lvl-2-nll.png}}\\
\subfloat[level 1 + ph loss]{\label{sfig:b0}\includegraphics[width=.33\textwidth]{images/lava-tsne/ae-lvl-0-bce.png}}\hfill
\subfloat[level 2 + ph loss]{\label{sfig:b1}\includegraphics[width=.33\textwidth]{images/lava-tsne/ae-lvl-1-bce.png}}\hfill
\subfloat[level 3 + ph loss]{\label{sfig:b2}\includegraphics[width=.33\textwidth]{images/lava-tsne/ae-lvl-2-bce.png}}\\
...
\begin{figure}[h]
\centering
\subfloat[level 1]{\label{sfig:c0}\includegraphics[width=.33\textwidth]{images/lava-tsne/ft-lvl-0-nll.png}}\hfill
\subfloat[level 2]{\label{sfig:c1}\includegraphics[width=.33\textwidth]{images/lava-tsne/ft-lvl-1-nll.png}}\hfill
\subfloat[level 3]{\label{sfig:c2}\includegraphics[width=.33\textwidth]{images/lava-tsne/ft-lvl-2-nll.png}}\\
\subfloat[level 1 + ph loss]{\label{sfig:d0}\includegraphics[width=.33\textwidth]{images/lava-tsne/ft-lvl-0-bce.png}}\hfill
\subfloat[level 2 + ph loss]{\label{sfig:d1}\includegraphics[width=.33\textwidth]{images/lava-tsne/ft-lvl-1-bce.png}}\hfill
\subfloat[level 3 + ph loss]{\label{sfig:d2}\includegraphics[width=.33\textwidth]{images/lava-tsne/ft-lvl-2-bce.png}}\\
